...
from src.api.openapi.api_response import ApiResponse, T as ApiResponseT
import src.api.openapi.models
from src.api.openapi import rest
from src.api.openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(src.api.openapi.models, klass)
