...
class PredictionModel(BaseModel):
    ...
    doas: Optional[List[Doa]] = Field(default=None, description="List of Domain of Applicability (DoA) configurations")
    ...
    extra_config: Optional[Dict[str, Any]] = Field(default=None, description="Additional configuration settings, optional", alias="extraConfig")
    ...
    __properties: ClassVar[List[str]] = ["id", "dependentFeatures", "independentFeatures", "type", "rawModel", "doas", "selectedFeatures", "task", "featurizers", "preprocessors", "torchConfig", "extraConfig", "legacyAdditionalInfo", "legacyPredictionService"]
