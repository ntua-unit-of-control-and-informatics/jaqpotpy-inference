...
class ModelSummary(BaseModel):
    ...
    type: ModelType
    dependent_features_length: Optional[StrictInt] = Field(
        default=None, alias="dependentFeaturesLength"
    )
    independent_features_length: Optional[StrictInt] = Field(
        default=None, alias="independentFeaturesLength"
    )
    shared_with_organizations: List[OrganizationSummary] = Field(
        alias="sharedWithOrganizations"
    )
    created_at: datetime = Field(
        description="The date and time when the feature was created.", alias="createdAt"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "sharedWithOrganizations": [
                    OrganizationSummary.from_dict(_item)
