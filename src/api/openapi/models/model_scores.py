...
class ModelScores(BaseModel):
    ...
    cross_validation: Optional[List[Scores]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "train": [Scores.from_dict(_item) for _item in obj["train"]]
                if obj.get("train") is not None
                else None,
                "test": [Scores.from_dict(_item) for _item in obj["test"]]
                if obj.get("test") is not None
                else None,
                "crossValidation": [
                    Scores.from_dict(_item) for _item in obj["crossValidation"]
                ]
                if obj.get("crossValidation") is not None
                else None,
            }
        )
        return _obj
