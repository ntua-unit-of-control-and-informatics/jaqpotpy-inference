...
class Scores(BaseModel):
    ...
    binary_classification: Optional[BinaryClassificationScores] = Field(
        default=None, alias="binaryClassification"
    )
    multiclass_classification: Optional[MulticlassClassificationScores] = Field(
        default=None, alias="multiclassClassification"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "regression": RegressionScores.from_dict(obj["regression"])
                if obj.get("regression") is not None
                else None,
                "binaryClassification": BinaryClassificationScores.from_dict(
                    obj["binaryClassification"]
                )
                if obj.get("binaryClassification") is not None
                else None,
                "multiclassClassification": MulticlassClassificationScores.from_dict(
                    obj["multiclassClassification"]
                )
                if obj.get("multiclassClassification") is not None
                else None,
            }
        )
        return _obj
