...
from src.entities import SinglePredictionResultTorch


from .prediction_handlers_torch import (
...
def handle_prediction_torch(model_data: dict, input_values: list) -> List[SinglePredictionResultTorch]:
    """
    ...
    Returns:
    - List[SinglePredictionResultTorch]: A list of prediction results.
